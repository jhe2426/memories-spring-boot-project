package com.jhe.memories_back.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void setContext(String userId, HttpServletRequest request) {
        ...
        AbstractAuthenticationToken authenticationToken = new UsernamePasswordAuthenticationToken(userId, null, AuthorityUtils
        .NO_AUTHORITIES);
